  ...
  return (
    <div className="col px-1 bg-black/[0] rounded-lg mb-10">
      <img
        ...
        src="https://risk-taker0501.github.io/meditation-react/images/ahmetoz_realistic_portrait_of_a_blonde_attractive_woman_who_is__1400a914-7574-4ce4-b10a-429f2cf6747f-550x550.jpg"
      />

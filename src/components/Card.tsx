...
const Card: React.FC = () => {
  ...
  const handleClick = () => {
    navigate("/meditation-reactepisode");
  };
  return (
    <div
    ...
    >
      <img
        ...
        src="/meditation-reactimages/ahmetoz_realistic_portrait_of_a_blonde_attractive_woman_who_is__1400a914-7574-4ce4-b10a-429f2cf6747f-550x550.jpg"
      />
